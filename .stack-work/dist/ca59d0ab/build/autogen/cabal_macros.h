...
/* package circular-buffer-0.1.0.0 */
#define VERSION_circular_buffer "0.1.0.0"
#define MIN_VERSION_circular_buffer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "circular-buffer-0.1.0.0-LXs98pV3tAc6KssAaDkw8s"

#define CURRENT_PACKAGE_KEY "circular-buffer-0.1.0.0-LXs98pV3tAc6KssAaDkw8s"
